...
router.post('/', function (req, res, next) {
    canal.connect(function(erro, conexao, feito){
      ...
      if (erro){
        ...
        const sql = 'insert into tb_comentario (id_comentario, conteudo_comentario, avaliaco_comentario, id_usuario, id_livro, id_lista, data_criacao) values (\'' + req.body.id_comentario + '\', \'' + req.body.conteudo_comentario + '\', \'' + req.body.avaliacao_comentario + '\',\'' + req.body.id_usuario + '\',\'' + req.body.id_livro + '\',\'' + req.body.data_criacao + '\')';
        console.log(sql);
...
router.delete('/lista/:id', function (req, res, next) {
	canal.connect(function(erro, conexao, feito){
        ...
        const sql = 'delete from tb_comentario where id_lista =  ' + req.params.id;
        console.log(sql);
		conexao.query(sql, function(erro, resultado){
			feito();
			if (erro){
...
router.delete('/livro/:id', function (req, res, next) {
	canal.connect(function(erro, conexao, feito){
        ...
        const sql = 'delete from tb_comentario where id_livro =  ' + req.params.id;
        console.log(sql);
		conexao.query(sql, function(erro, resultado){
			feito();
			if (erro){
